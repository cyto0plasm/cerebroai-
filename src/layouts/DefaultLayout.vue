<template>
  <div class="min-h-screen flex flex-col bg-surface-50 dark:bg-surface-950 text-surface-800 dark:text-surface-100">
    <header class="sticky top-0 z-40 border-b border-surface-200/80 dark:border-surface-800 bg-surface-0/90 dark:bg-surface-900/90 backdrop-blur-md">
    ...
    <div class="border-b border-surface-200/60 dark:border-surface-800 bg-surface-100/50 dark:bg-surface-900/50 px-4 sm:px-6 lg:px-8 py-2">
      ...
      <div class="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between gap-6">
        ...
        <div class="flex gap-10 text-sm text-surface-500">
          <div class="flex flex-col gap-2">
            ...
            <router-link v-for="link in navLinks" :key="link.to" :to="link.to" class="hover:text-brand-600">{{ link.label }}</router-link>
          </div>
          <div class="flex flex-col gap-2">
